...
#
println("...for starting a simulation with different patches and race tracking")
rtmsim.rtmsim_rev1(1,"..\\meshfiles\\mesh_permeameter1_foursets.bdf",200, 101325,1.225,1.4,0.06, 1.35e5,1.00e5, 3e-3,0.7,3e-10,1,1,0,0, 3e-3,0.7,3e-10,1,1,0,0, 3e-3,0.7,3e-11,1,1,0,0, 3e-3,0.7,3e-11,1,1,0,0, 3e-3,0.7,3e-9,1,1,0,0, 1,2,2,2, 0,"results.jld2",0,0.01,16) 
#
println("...for continuing the previous simulation")
...
#
#println("...for the manual selection of inlet ports with left mouse button click while key p is pressed")
#rtmsim.plot_mesh("..\\meshfiles\\mesh_annulusfiller1.bdf",2) 
#
#println("...for starting only with the interactively selected inlet ports")
...
#
println("...for plotting the final filling and pressure contours")
rtmsim.plot_results("results.jld2") 
#
println("...for plotting the filling contours at four equidistant time instances")
rtmsim.plot_overview(-1,-1) 
#
println("...for plotting the filling at different time instances selected with a slider bar")
rtmsim.plot_filling(-1,-1) 
#
println("...for starting a simulation with the parameters specified in the text file input.txt")
